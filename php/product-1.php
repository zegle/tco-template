...
<head>
    ...
    <title>TurboChargedOutfitters | Focus ST Splitter</title>
</head>
        ...
        <section class="section-product">
            <div class="wrapper">
                <div class="grid-6 mt-4">
                    <div class="col-3 col-6s product-image-1">
                        &nbsp;
                    </div>
                    <div class="col-3 col-6s">
                        <h2 class="product-title">Focus ST Splitter</h2>
                        <h2 class="product-price mb-4">$180.00</h2>
                        <p class="product-text mb-2">
                            Change the look of your cars front end and make it aggressive!<br>
                            Crack resistant as our products are made of an Aluminum Composite.<br>
                            Scratch resistant due to our multi-stage powder coating.<br>
                    ...
                    <div class="col-6 mt-4 mt-1xs mb-6">
                        ...
                        <div class="grid-6">
                            ...
                            <div class="col-2 product text-center">
                                ...
                                <h5 class="product-title d-inline">Focus ST Wing Extension</h5>
                                <h4 class="product-price mb-1 d-inline">$105.00</h4>
                            </div>
                            <div class="col-2 product text-center">
                                <div class="product-img-box">
