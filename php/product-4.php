...
<head>
    ...
    <title>TurboChargedOutfitters | Focus ST Diffuser</title>
</head>
        ...
        <section class="section-product">
            <div class="wrapper">
                <div class="grid-6 mt-4">
                    <div class="col-3 col-6s product-image-4">
                        &nbsp;
                    </div>
                    <div class="col-3 col-6s">
                        <h2 class="product-title">Focus ST Diffuser</h2>
                        <h2 class="product-price mb-4">$299.00</h2>
                        <p class="product-text mb-2">
                            Add some aggressive aero to the rear bumper and make your rear end look sharp but clean!
