...
<head>
    ...
    <title>TurboChargedOutfitters | WRX/STI Splitter</title>
</head>
        ...
        <section class="section-product">
            <div class="wrapper">
                <div class="grid-6 mt-4">
                    <div class="col-3 col-6s product-image-6">
                        &nbsp;
                    </div>
                    <div class="col-3 col-6s">
                        <h2 class="product-title">WRX/STI Splitter</h2>
                        <h2 class="product-price mb-4">$240.00</h2>
                    ...
                    <div class="col-6 mt-4 mt-1xs mb-6">
                        ...
                        <div class="grid-6">
                            <div class="col-2 product text-center">
                                ...
                                <h5 class="product-title d-inline">BRZ/FRS Splitter</h5>
                                <h4 class="product-price mb-1 d-inline">$120.00</h4>
                            </div>
                            <div class="col-2 product text-center">
                                <div class="product-img-box">
