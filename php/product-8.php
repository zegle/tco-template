...
<head>
    ...
    <title>TurboChargedOutfitters | Fiesta ST Wing Extension v2</title>
</head>
        ...
        <section class="section-product">
            <div class="wrapper">
                <div class="grid-6 mt-4">
                    <div class="col-3 col-6s product-image-8">
                        &nbsp;
                    </div>
                    <div class="col-3 col-6s">
                        <h2 class="product-title">Fiesta ST Wing V2</h2>
                        <h2 class="product-price mb-4">$125.00</h2>
